...
class VideoCamera(object):
    def __init__(self):
        ...
        modelfile1 = os.path.join(dir_path, 'stacker2-model1.eim')
        ...
        modelfile3= os.path.join(dir_path, 'stacker2-model3.eim')
    ...
    def move_to_shoe(self):
        ...
        if len(res["result"]["bounding_boxes"]) > 0:
            ...
            if (bb['label'] == 'shoe'):
                ...
                cropped = cv2.putText(cropped, bb['label'], (bb['x'], bb['y'] + 25), font, 1, (0, 255, 0), 2, cv2.LINE_AA)
                if(bb['y'] > 170):
                    if (self.cam_pulse < self.cam_max):
                        self.lower_camera()
